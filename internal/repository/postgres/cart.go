...
func MyNewPostgresCart(db *pgxpool.Pool) CartRepository {
...
func (r *Repository) GetCart(userID int) (entity.Cart, error) {
...
func (r *Repository) GetOrCreateCart(userID int) (entity.Cart, error) {
...
func (r *Repository) AddItemToCart(cartID, productID, quantity int) error {
...
func (r *Repository) UpdateQuantity(cartItemID int, act string) error {
	const op = "postgres.UpdateQuantity"
...
func (r *Repository) GetCartItems(cartID int) ([]entity.CartItem, error) {
	const op = "postgres.GetCartItems"
...
func (r *Repository) RemoveItem(cartItemID int) error {
